...
public class HelpCommand extends ParentCommand{
	...
	public void perform(Player player, String[] args) {
		...
		ParentCommand command, mainCommand = main.getCommandManager().getCommandByName("show");
	...
	public void createList(Player player, ParentCommand command, int page) {
		...
		if(page > helpSize) {
			player.sendMessage(GeneralMethods.format(language.getString("Command.Help.EndOfHelp.Message")));
		}
	}
